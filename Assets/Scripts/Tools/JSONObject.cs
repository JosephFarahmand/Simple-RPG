...
public static class JSONObjectExtention
{
	...
	public static Vector2 ToVector2(this JSONObject json)
	{
		var result = new Vector2();
		if (!json.HasFields(new string[2] { "x", "y" }))
		{
			Debug.LogError("Invalide json!");
			return Vector2.zero;
		}
		result.x = json["x"].f;
		result.y = json["y"].f;
	...
	public static Vector3 ToVector3(this JSONObject json)
	{
		...
		if (!json.HasFields(new string[3] { "x", "y", "z" }))
		{
			Debug.LogError("Invalide json!");
			return Vector3.zero;
		}
	...
	public static JSONObject ToJSON<T>(this IList<T> list)
	{
	...
	public static JSONObject ToJSON<T>(this T[] list)
	{
		JSONObject json = new JSONObject(JSONObject.Type.ARRAY);
		foreach (var item in list)
		{
